...
export default function Dashboard() {
  const cardStyle =
    "flex flex-col items-center justify-center bg-white shadow-md rounded-2xl p-6 hover:scale-105 transition-all duration-300";
        ...
        <ul className="flex justify-center mx-auto w-full">
          {["Make Schedule", "Add Subjects", "Quiz", "Performance", "History"].map((item, idx) => {
            ...
            return (
              ...
              >
                <a href={`/${path}`} className="block w-full h-full no-underline">
                  {item}
                </a>
              </li>
            );
      ...
      <div className="grid grid-cols-2 gap-8 max-w-4xl mx-auto">
        <Link href="/make-schedule">
          <div className={cardStyle}>
            <div className="w-full h-40 bg-gray-200 flex items-center justify-center rounded-xl text-xl text-red-500">
              Image
            </div>
